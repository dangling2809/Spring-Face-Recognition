    ...
    <head>
        ...
        <script>
            window.webcam = {
                ...
                swf_url: '${context}/resources/flash/webcam.swf', // URI to webcam.swf movie (defaults to cwd)        
                shutter_url: '${context}/resources/flash/shutter.mp3', // URI to shutter.mp3 sound
                ...
                set_shutter_sound: function(enabled, url) {
                    ...
                    this.shutter_url = url ? url : '${context}/resources/flash/shutter.mp3';
                },
